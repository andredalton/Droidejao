...
public class Help extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        (
            "<b>Objetivos:</b> O sistema Droidej&atilde;o foi feito pensando em facilitar a escolha dos card&aacute;pios dos bandej&otilde;es do campus da capital da USP.<br>\n" +
//            "Para tanto ele recolhe informa&ccedil;&otilde;es de um servidor que cont&eacute;m os card&aacute;pios j&aacute; pr&eacute;-processados e um indice de atualiza&ccedil;&atilde;o. Possibilitando assim manter uma quantidade m&iacute;nima de downloads para manter o sistema funcional e atualizado.<br><br>\n" +
            ...
            "<b>Cores:</b> Toda vez que a validade do card&aacute;pio estiver vencida, o mesmo ser&aacute; mostrado <font color="+R.color.text_outdate+">nessa cor</font>, caso contr&aacute;rio aparecer&aacute; <font color="+R.color.text+">nessa cor</font>.<br><br>\n" +
